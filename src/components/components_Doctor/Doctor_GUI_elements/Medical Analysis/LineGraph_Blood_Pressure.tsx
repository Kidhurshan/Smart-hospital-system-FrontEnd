...
export default function StatisticsChart() {
  const options: ApexOptions = {
    ...
    colors: ["#465FFF", "#52e5f3"], // Define colors for systolic and diastolic lines
    chart: {
  ...
  const series = [
    {
      name: "Systolic",
      data: [120, 125, 130, 128, 127, 135, 132, 130, 125, 124, 130, 128],
    },
    {
      name: "Diastolic",
      data: [80, 82, 84, 81, 83, 85, 83, 82, 80, 81, 82, 84],
    },
  ];
      ...
      <div className="flex flex-col gap-5 mb-6 sm:flex-row sm:justify-between">
        <div className="w-full">
          ...
          <p className="mt-1 text-gray-500 text-theme-sm dark:text-gray-400">
            Systolic and Diastolic blood pressure levels over the months
          </p>
        </div>
      </div>
