...
export default function PatientTable() {
  const { doctors } = useSelector((state: any) => state.usersState);

  const formattedData: User[] = Array.isArray(doctors)
    ? doctors.map((u: any) => ({
        id: u._id,
        user: {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex justify-center items-center gap-5">
        ...
        <Link to="/ma_form_Register_doctor" className="contents cursor-pointer">
          <Button
            size="sm"
            variant="outline"
