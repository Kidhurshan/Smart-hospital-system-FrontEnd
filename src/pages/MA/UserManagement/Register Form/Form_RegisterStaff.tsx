...
import { registerStaff } from "../../../../actions/MA_Actions/usersActions.js";
...
export default function FormElements() {
  ...
  useEffect(() => {
    ...
    if (message) {
      ...
      navigate(APP_ROUTES.STAFF_TABLE_PAGE);
      return;
    }
  }, [error, message]);
  ...
  return (
    <div>
      <PageMeta title="Staff Register Form" description="Register Form" />
      <PageBreadcrumb pageTitle="Register new Staff" />
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-5 ml-15">
            ...
            <Link to={APP_ROUTES.STAFF_TABLE_PAGE} className="DoctorTable">
              <Button
                size="sm"
                variant="outline"
